...
if __name__ == '__main__':
    ...
    data_files = {'solid_state': 'data/solid_state.json',
                  ...
                  'pero800':'data/pero800.json'}
    # model file dictionary
    model_files = {'bert': 'utils/bert-base-uncased',
                   'scibert': 'utils/scibert_scivocab_uncased',
                   'matbert': 'utils/matbert-base-uncased',
                ...
                for dataset in datasets:
                    ...
                    for model in models:
                        ...
                        if ner_data.dataloaders['test'] is not None and succeeded:
                            ...
                            with open(save_dir+'predictions.txt', 'w',encoding='utf-8') as f:
